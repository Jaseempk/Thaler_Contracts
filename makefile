...
deploy:
	@forge script script/DeployHonkVerifier.s.sol:DeployHonkVerifier $(NETWORK_ARGS)
...
verify:
	@forge verify-contract --chain-id 84532 --watch --etherscan-api-key $(ETHERSCAN_API_KEY) --compiler-version 0.8.27 0xEA63d1094Ef863aa572e7A3584e4be3a34649422 thaler_circuits/target/contract.sol:HonkVerifier 
