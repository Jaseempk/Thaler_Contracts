...
verify:
	@forge verify-contract --chain-id 84532 --watch --constructor-args `cast abi-encode "constructor(address)" "$(VERIFIER)"` --etherscan-api-key $(ETHERSCAN_API_KEY) --compiler-version 0.8.27 0x4c0cB3c185D3E1d8B276dbB3AcebCc3298CA418F src/ThalerSavingsPool.sol:ThalerSavingsPool 
